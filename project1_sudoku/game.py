...
if __name__ == "__main__":
    ...
    print("Time for BFS: ", timeit.timeit('bfs(puzzle, puzzle.board)', 'gc.enable()', number=10, globals=globals()) / 10)
    print("____________________________________________________________________________________")
    print("DFS solution: ", dfs(puzzle))
    print("Time for DFS: ", timeit.timeit('dfs(puzzle)', 'gc.enable()', number=10, globals=globals()) / 10)
    print("____________________________________________________________________________________")
    print("BFS with pruning solution: ", bfs_with_prunning(puzzle, puzzle.board))
    print("Time for BFS with pruning: ", timeit.timeit('bfs_with_prunning(puzzle, puzzle.board)', 'gc.enable()', number=10, globals=globals()) / 10)
    print("____________________________________________________________________________________")
    print("DFS with pruning solution: ", dfs_with_prunning(puzzle))
    print("Time for DFS with pruning: ", timeit.timeit('dfs_with_prunning(puzzle)', 'gc.enable()', number=10, globals=globals()) / 10)
    print("____________________________________________________________________________________")